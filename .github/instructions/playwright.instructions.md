...
- **Clarity**: Use descriptive test and step titles that clearly state the intent. Add comments only to explain complex logic, non-obvious interactions, or the reason for a test-specific workaround; do not restate the test steps.
...
- [ ] Code follows the repository formatting rules and comments explain intent rather than restating steps
